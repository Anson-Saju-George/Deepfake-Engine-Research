...
def with_image_train_log(config):
...
def train_image_experiment(config: dict) -> dict:
    """Shared image training loop used by family-specific runners."""
    return train_vit_image_experiment(config)
